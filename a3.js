...
function initMotions() {
    ...
    myboxMotion.addKeyFrame(new Keyframe('pose C',2.0, [-3, 6, 0, 0]));
    myboxMotion.addKeyFrame(new Keyframe('pose D',3.0, [0, 6, 0, 0]));
    ...
    handMotion.addKeyFrame(new Keyframe('right finger curl',1.0, [0, 3,    +60, +160, -160, 0,0]));
    handMotion.addKeyFrame(new Keyframe('straight',         2.0, [0, 3,    +120, 0, 0, 0, 0]));
    handMotion.addKeyFrame(new Keyframe('left finger curl', 3.0, [0, 3,    +180, 0, 0, -90,-90]));
    handMotion.addKeyFrame(new Keyframe('straight',         4.0, [0, 3,    +240, 0, 0, 0, 0]));
    handMotion.addKeyFrame(new Keyframe('both fingers curl',4.5, [0, 3,    +300, -90, -90, -90,-90]));
    handMotion.addKeyFrame(new Keyframe('straight',         6.0, [0, 3,    +360, 0, 0, 0, 0]));
}
